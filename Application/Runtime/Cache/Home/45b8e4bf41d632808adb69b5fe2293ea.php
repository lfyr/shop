    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="address_list" id="addressList" style="-webkit-transform-origin: 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">
                ...
                <div class="userAddress" id="<?php echo ($v["id"]); ?>" style="color: #000000">
                        <ul class="<?php if($v['def']==1) echo 'selected';?>">
                            <li onclick="setDefault(this);"><strong><?php echo ($v["shr_name"]); ?></strong> <?php echo ($v["shr_tel"]); ?></li>
                            <li class="temp_click" onclick="setDefault(this);">
                                    <?php echo ($v["shr_address"]); ?></li>
