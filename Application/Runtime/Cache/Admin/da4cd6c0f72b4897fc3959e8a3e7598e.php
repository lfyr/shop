...
<div class="leftnav">
  ...
  <h2><span class="<?php if($v['pri_name']=='系统权限管理'){ echo 'icon-gear';}elseif($v['pri_name']=='微信管理'){echo 'icon-weixin';}elseif($v['pri_name']=='商品管理'){echo 'icon-shopping-cart';}else{echo 'icon-pencil-square-o';}?>"></span><?php echo ($v["pri_name"]); ?></h2>
