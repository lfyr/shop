  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('add');?>">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="role_name" data-validate="required:请输角色名称" />
          <div class="tips"></div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="checkbox" level="<?php echo ($v["level"]); ?>"  name="pri_id[]" value="<?php echo ($v["id"]); ?>"  /><?php echo ($v["pri_name"]); ?><br/><br/>
          <?php endforeach;?>
          <div class="tips"></div>
        </div>
      </div>
