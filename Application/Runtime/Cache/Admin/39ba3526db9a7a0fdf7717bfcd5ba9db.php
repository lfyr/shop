    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach($data as $v):?>
        <tr>
          ...
          <td><div class="button-group"><a onclick="return confirm('确定要还原吗？');" class="button border-main" href="<?php echo U('restore?id='.$v['id'].'&p='.I('get.p'))?>"><span class="icon-mail-forward"></span> 还原</a> <a class="button border-red" href="<?php echo U('del?id='.$v['id'].'&p='.I('get.p'))?>" onclick="return confirm('确定要删除吗？');" ><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
      <?php endforeach;?>
