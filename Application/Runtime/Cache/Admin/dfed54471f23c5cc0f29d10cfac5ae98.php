  ...
  <div class="body-content">
    ...
    <input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
      <div class="form-group">
        ...
        <div class="field">
            <select name="parent_id" class="input w50">
              ...
              <?php if($v['id'] == $data['id'] || in_array($v['id'], $children)) continue;?> <!-- 禁止本身分类出现，禁止本身子类出现 -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data["cat_name"]); ?>" name="cat_name" data-validate="required:请输分类名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
