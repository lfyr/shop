  ...
  <div class="body-content">
    ...
    <?php endif;?>
      ...
      <div class="form-group">
          ...
          <div class="field" style="padding-top:8px;"> 
            启用 <input id="ishome"  name="is_use" value="1" <?php if($data['is_use']==1) echo 'checked="checked"'; ?>  type="radio"/>
            禁用 <input id="isvouch" name="is_use" value="2" <?php if($data['is_use']==0) echo 'checked="checked"'; ?> type="radio" />
          </div>
      </div>
      <?php endif;?>
      <div class="form-group">
