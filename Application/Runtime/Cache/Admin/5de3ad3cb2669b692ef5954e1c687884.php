  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">  
      <div class="form-group">
        ...
        <div class="field">
            <select name="type_id" class="input w50" onchange="location.href='/index.php/Admin/Attribute/edit/type_id/'+this.value;">
              <option value="0">选择类型</option>
              <?php foreach($typeData as $v): if($type_id==$v['id']){ $select = 'selected="selected"'; }else{ $select=""; } ?>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data["attr_name"]); ?>" name="attr_name" data-validate="required:请输属性名称" />
          <div class="tips"></div>
        </div>
      ...
      <div class="form-group">
            ...
            <div class="field">
              <textarea name="attr_option_values" class="input" style="height:120px;"><?php echo ($data["attr_option_values"]); ?></textarea>
              <div class="tips"></div>
            </div>
      </div>
      <div class="form-group">
