  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('add');?>">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="null" name="pri_name" data-validate="required:请输权限名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="null" name="module_name" data-validate="required:请输模块名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="null" name="controller_name" data-validate="required:请输控制器名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="null" name="action_name" data-validate="required:请输方法名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
